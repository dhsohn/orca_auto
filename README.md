...
[public contracts](https://github.com/dhsohn/orca_auto/blob/v8.0.0/docs/PUBLIC_CONTRACTS.md),
...
- A change to how ORCA_auto runs the engine also needs a bounded run with the real
  ...
  convergence or frequencies ([validation](https://github.com/dhsohn/orca_auto/blob/v8.0.0/docs/VALIDATION.md)).
