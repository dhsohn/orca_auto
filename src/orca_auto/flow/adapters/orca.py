...
def _contract_loader_deps() -> OrcaContractLoaderDeps:
    return OrcaContractLoaderDeps(
        ...
        status_from_payloads_fn=_contract_status.status_from_payloads,
        ...
        attempt_count_fn=_contract_status.attempt_count,
        max_retries_fn=_contract_status.max_retries,
        coerce_attempts_fn=_contract_status.coerce_attempts,
        final_result_payload_fn=_contract_status.final_result_payload,
