...
_CANCEL_ENGINE_TARGETS: dict[str, str | Callable[..., dict[str, Any]]] = {
    "crest": "orca_auto.flow.submitters.crest",
    "xtb": "orca_auto.flow.submitters.xtb",
}
...
def cancel_workflow_activity(
    ...
    require_workflows()
    from orca_auto.flow.orchestration import cancel_materialized_workflow
...
def cancel_workflow_stage_engine_activity(
    ...
    require_workflows()
    if isinstance(cancel_target, str):
        cancel_target = import_module(cancel_target).cancel_target
