...
from orca_auto.core.queue.dependencies import WorkerConfig

from .definitions import EngineDefinition


def get_engine_definition(engine: str) -> EngineDefinition[WorkerConfig]:
    ...
    return cast(EngineDefinition[WorkerConfig], definition)
