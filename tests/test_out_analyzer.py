...
class TestOutAnalyzer(unittest.TestCase):
    ...
    def test_ts_line_rule_matches_the_workflow_recount_across_a_form_feed(self) -> None:
        ...
        self.assertEqual(recount, (1, True))
        self.assertEqual(result.reason, "ts_criteria_met")
        self.assertEqual(result.markers["imaginary_frequency_count"], recount[0])
        self.assertEqual(result.markers["final_frequency_section"], recount[1])
...
def test_input_block_syntax_abort_is_error_termination_evidence():
