...
def _print_outcome(entry: Any, outcome: Any) -> None:
    # The xTB parent worker prints these four lines after a child exits; the
    # in-process harness prints them from the outcome for both engines so
    # smoke tests can assert one surface.
