...
def test_load_orca_artifact_contract_short_circuits_on_tracked_payload(
    ...
    # Producer-shaped values: the payload builders normalize every key they
    # emit, so the assembler passes them straight through.
    payload = {
        "run_id": "run_payload_1",
        "status": "completed",
        "reason": "normal_termination",
        "state_status": "completed",
        "reaction_dir": str(tmp_path / "rxn_payload"),
        "latest_known_path": str(tmp_path / "outputs" / "run_payload_1"),
        "optimized_xyz_path": str(tmp_path / "outputs" / "run_payload_1" / "final.xyz"),
        "queue_id": "q_payload_1",
        "queue_status": "completed",
        "cancel_requested": True,
        "selected_inp": str(tmp_path / "outputs" / "run_payload_1" / "rxn.inp"),
        "selected_input_xyz": str(tmp_path / "outputs" / "run_payload_1" / "rxn.xyz"),
        "analyzer_status": "completed",
        "completed_at": "2026-04-19T00:10:00+00:00",
        "last_out_path": str(tmp_path / "outputs" / "run_payload_1" / "rxn.out"),
