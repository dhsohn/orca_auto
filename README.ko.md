...
[공개 인터페이스 규격](https://github.com/dhsohn/orca_auto/blob/v7.0.1/docs/PUBLIC_CONTRACTS.ko.md)에
...
- ORCA_auto가 엔진을 실행하는 방식을 바꾸는 변경은 실제 ORCA 엔진으로 범위를 제한한 계산을 돌리고,
  ...
  ([검증](https://github.com/dhsohn/orca_auto/blob/v7.0.1/docs/VALIDATION.md)).
