...
from orca_auto.core.activity import ActivityRecord, mapping_text, unique_texts
...
def workflow_elapsed_metadata(
    *,
    ...
    restart_summary = mapping_or_empty(record_metadata.get("restart_summary")) or mapping_or_empty(
...
def _workflow_activity_record(
    ...
    *,
    ...
    record_metadata = mapping_or_empty(getattr(record, "metadata", {}))
    ...
    return ActivityRecord(
        ...
        metadata={
            ...
            "request_parameters": mapping_or_empty(summary.get("request_parameters")),
            "workspace_dir": normalize_text(record.workspace_dir),
